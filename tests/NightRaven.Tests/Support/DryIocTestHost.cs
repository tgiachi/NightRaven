...
/// <summary>
/// Test helper mirroring the production DryIoc wiring: NightRaven services register natively on a
...
{
    /// <summary>
    /// Resolves the orchestrator that drives the registered NightRaven services, as the host sees it.
    /// </summary>
    public static IHostedService Orchestrator(this IContainer container)
        => container.Resolve<NightRavenServiceOrchestrator>();
}
