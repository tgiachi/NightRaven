...
public class TomlUtilsTests : IDisposable
{
    ...
    {
        Assert.Throws<ArgumentNullException>(
            () => TomlUtils.Deserialize<TomlPerson>("name = \"x\"", (TomlTypeInfo<TomlPerson>)null!)
        );
    }
    ...
    public void SerializeToFile_NullObject_Throws()
    {
        ...
        Assert.Throws<ArgumentNullException>(
            () => TomlUtils.SerializeToFile<TomlPerson>(null!, filePath, TomlTestContext.Default.TomlPerson)
        );
    }
